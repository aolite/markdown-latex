...
\orcidauthorONE{0000-0000-000-000X} % Add \orcidONE{} behind the author's name
%\orcidauthorTWO{0000-0000-000-000X} % Add \orcidTWO{} behind the author's name

% Authors, for the paper (add full first names)
\Author{Firstname Lastname $^{1,\dagger,\ddagger}$\orcidONE{}, Firstname Lastname $^{1,\ddagger}$ and Firstname Lastname $^{2,}$*}
